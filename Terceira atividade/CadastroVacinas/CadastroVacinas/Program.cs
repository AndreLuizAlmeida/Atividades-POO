...
namespace CadastroVacinas
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            {
                Console.WriteLine($"CPF: {cidadao.Cpf}, Nome: {cidadao.Nome}, Idade: {cidadao.Idade}, Vacinado: {(cidadao.Vacinado ? "Sim" : "Não")}, Telefone: {cidadao.Telefone}, Email: {cidadao.Email}");
            }
